...
const SideBar = () => {
  const { theme, isShowmenu } = useTheme();

  return (
    <>
      {isShowmenu && (
        <div
          className="font-[roboto] hidden lg:block bg-white lg:w-1/5 h-screen pt-14 overflow-y-auto dark:bg-[#0f0f0f] [&::-webkit-scrollbar]:[width:8px] 
        ...
        >
          ...
          <hr className="my-2 dark:text-[#292929]" />
